 ...
 * @author Christoffer
 */
public class Backman extends MovableEntityAbstract {

    private static String texturePath = "/res/images/backman.png";
    ...
    private ArrayList<Integer> allowedTiles;            // The tiles that Backman is allowed to walk on
    /*
     * Stats
     */
    private int points;
    ...
    private float immortalTimerMax = 3000;              // For how long should Backman be immortal after
    private float immortalTimer = 0;                    // he's become immortal
    /*
     * Colors for making pacman orange (and transparent when immortal).
     */
    private Vector4f color = new Vector4f(1, 0.5f, 0, 1);
    private Vector4f standardColortransparent = new Vector4f(1, 0.5f, 0, 0.2f);
    private Vector4f standardColor = new Vector4f(1, 0.5f, 0, 1);

    /**
     *
     * @param level
     */
    public Backman(Level level) {
        super();
     ...
     * through updates. Makes Backman flash between transparent and yellow when
    ...
    public void update(float delta) {
        ...
        if (immortal) {
            ...
            if (immortalTimer % 300 < 150) {
                color = standardColortransparent;
     ...
     * stop Backman from getting stuck, when trying to enter a side corridor.
     *
     * @param dx
     * @param dy
     */
    ...
    /**
     * Spawns Backman at tile (tileX, tileY). Remember that Backman is two tiles
     * wide and high.
     *
     * @param tileX
     * @param tileY
     ...
     * called when Backman is being killed.
     *
     * @param points
     */
