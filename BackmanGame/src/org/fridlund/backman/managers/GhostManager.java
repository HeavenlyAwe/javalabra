...
import org.fridlund.backman.entities.Ghost;
import org.fridlund.backman.entities.GhostGraphics;
...
public class GhostManager extends Manager {
     ...
     */
    public GhostManager(GameplayScene game, Backman pacman, Level level, int numberOfGhosts) {
    ...
    /**
     * Method that checks what to do if Backman is killed (or at least tried to
     * be killed).
     */
    ...
    /**
     * Makes the ghosts able to get out from the nest. If Backman is invincible
    ...
    /**
     * Makes all ghosts that are loose in the labyrinth killable by Backman. This
     * method should only be called from GameplayScene, which is triggered by
     * the SnackManager class, when Backman eats a SuperSnack.
     */
