...
import org.fridlund.backman.entities.Direction;
import org.fridlund.backman.entities.Backman;
import org.fridlund.backman.entities.Snack;
import org.fridlund.backman.entities.SpecialAction;
import org.fridlund.backman.entities.SpecialSnack;
import org.fridlund.backman.entities.SuperSnack;
...
public class SnackManager extends Manager {
    ...
    private float superSnackTimerMax;           // for how long time will Backman be invincible when eating a SuperSnack
    ...
    private ArrayList<Integer> allowedTiles;    // This is basically the same as Backman.allowedTiles
     ...
     * @param level
     */
    public SnackManager(GameplayScene game, Backman pacman, Level level) {
    ...
    /**
     * Used for checking if level is complete and if Backman has eaten a
    ...
    /**
     * Controls the invincibility of Backman, by checking if he has eaten a
    ...
    /**
     * Controls if Backman has eaten a snack, and what kind of snack in case he
     * eats one.
     *
     * @param delta
     */
