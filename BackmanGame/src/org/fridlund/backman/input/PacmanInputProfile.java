 ...
 */
package org.fridlund.backman.input;
...
/**
 * Handles all the input in the Backman game. Have fields of the different
...
public class PacmanInputProfile extends InputProfile {
     ...
     * @param level
     */
    public PacmanInputProfile(GameplayScene game, Backman pacman, Level level) {
        super();
...
//        }
    ...
    //=================================================================
    /**
     * Based upon the current DX and DY, the animation on Backman is chosen here.
     */
    ...
    /**
     * Makes sure that Backman can't go in y-direction when he has left the level
     * for teleportation.
     */
    ...
    /**
     * Teleports Backman from one side to the other, when he has left the level
